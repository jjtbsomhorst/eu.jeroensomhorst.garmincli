...
class GarminCliCommand extends Command
{
    ...
    protected function configure()
    {
        ...
        $this->addOption('unattended','u',InputOption::VALUE_NONE);
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if($this->hasConfiguration()){
            if(!$input->getOption('unattended')) {
                $this->showConfiguration($output);
                $q = new ConfirmationQuestion("Use these settings?",true);
                $a = $helper->ask($input,$output,$q);
                if($a == false){
                    $this->askQuestions($helper, $input, $output);
                }
            }
        }else{
            $this->askQuestions($helper, $input, $output);
     ...
     * @param OutputInterface $output
     */
    protected function askQuestions(mixed $helper, InputInterface $input, OutputInterface $output): void
    {
